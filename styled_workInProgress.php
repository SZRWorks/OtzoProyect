    ...
    <div align="center">
        <div class="card border-danger bg-primary text-light shadow" style="max-width: 550px; margin-top: 60px;">
            <div class="card-header text-center text-light">
                <span class="text-danger h2">  Trabajo en Proceso  </span>
            </div>
            
            <div class="card-body">
                <h2 class="text-warning"> Ups! 0_o</h2> <br>

                Parece que te topaste con una caracteristica que no hemos terminardo :/ <br>

                Que tal si volvemos ;) <br> <br>

                <button class="btn btn-warning text-light" onclick="location.href='javascript: history.go(-1)'">
