...
class ConcretBuilder implements Builder {
    ...
    public function crearCard(): void{
        echo '<div class="col-md-4"><div class="card border border-warning bg-dark" style="height: 550px; margin-bottom: 20px;">';
    }
    ...
    public function crearTitulo(): void {
        echo '<hr><div class="card-body"><h4 class="card-title text-primary">' . $this->data["Titulo"];
    }
